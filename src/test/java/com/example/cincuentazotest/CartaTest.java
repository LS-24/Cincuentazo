...
public class CartaTest {
    ...
    public void testCreacionCarta() {
        ...
        assertEquals("As de Espadas", carta.getNombre(), "El nombre de la carta debe ser 'As de Espadas'");
    ...
    public void testValorTemporal() {
        ...
        assertEquals(15, carta.getValor(), "El valor temporal debe ser 15");
    }
    ...
    public void testValorOriginal() {
        ...
        assertEquals(12, carta.getValor(), "El valor de la carta debe ser 12");
    }
    ...
    public void testCartaSinImagenYNombres() {
        ...
        assertEquals("", carta.getNombre(), "El nombre debe ser una cadena vacía");
        assertEquals("", carta.getImagen(), "La imagen debe ser una cadena vacía");
        assertEquals(1, carta.getValor(), "El valor debe ser 1");
    }
}
